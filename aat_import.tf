...
# import {
#   for_each = { for k, v in local.env_subs : k => v if k == "aat" }
#   id       = "https://ccd-${each.key}.vault.azure.net/secrets/ccd-ELASTIC-SEARCH-URL/726c8bba17294a36bb6f40aa39f6f802"
#   to       = azurerm_key_vault_secret.elastic_search_url_key_setting
# }

# import {
#   for_each = { for k, v in local.env_subs : k => v if k == "aat" }
#   id       = "https://ccd-${each.key}.vault.azure.net/secrets/ccd-ELASTIC-SEARCH-DATA-NODES-URL/66d53a79e62042d49388420194d209ed"
...
# # import {
# #   for_each = { for k, v in local.env_subs : k => v if k == "aat" }
# #   /subscriptions/1c4f0704-a29e-403d-b719-b90c34ef14c9/resourceGroups/ccd-elastic-search-aat/providers/Microsoft.Network/loadBalancers/ccd-internal-aat-lb
...
# # azurerm_lb_backend_address_pool_address.elastic_vm
