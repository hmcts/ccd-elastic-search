...
lb_private_ip_address = "10.96.85.253"
soc_vault_name        = "soc-prod"
soc_vault_rg          = "soc-core-infra-prod-rg"

storage_account_name = "ccdelasticsnapshotprod"
...
nsg_security_rules = {
  ...
  PTL_AKS_To_ES = {
    ...
    destination_address_prefix                 = null
    destination_application_security_group_ids = "id"
    source_address_prefixes                    = ["10.10.72.0/23", "10.10.74.0/23"]
  },
  App_To_ES = {
    name                                       = "App_To_ES"
    ...
    source_port_range                          = "*"
    destination_port_range                     = "9200"
    source_address_prefix                      = "10.96.76.0/22"
    destination_address_prefix                 = null
    destination_application_security_group_ids = "id"
  },
  AKS_To_ES = {
    ...
    destination_port_range                     = "9200"
    source_address_prefix                      = null
    source_address_prefixes                    = ["10.90.64.0/20", "10.90.80.0/20"]
    destination_address_prefix                 = null
    destination_application_security_group_ids = "id"
  },
  Jenkins_To_ES = {
  ...
  Bastion_To_VMs = {
    ...
    destination_address_prefix = "10.96.85.0/24"
  },
  DenyAllOtherTraffic = {
