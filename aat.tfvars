...
lb_private_ip_address = "10.96.149.253"
...
nsg_security_rules = {
  ...
  App_To_ES = {
    ...
    source_port_range                          = "*"
    destination_port_range                     = "9200"
    source_address_prefix                      = "10.96.140.0/22"
    destination_address_prefix                 = null
    destination_application_security_group_ids = "id"
  },
  AKS_To_ES = {
    ...
    destination_port_range                     = "9200"
    source_address_prefix                      = null
    source_address_prefixes                    = ["10.10.144.0/20", "10.10.128.0/20"]
    destination_address_prefix                 = null
    destination_application_security_group_ids = "id"
  },
  Jenkins_To_ES = {
  ...
  Bastion_To_VMs = {
    ...
    destination_port_range     = "22"
    source_address_prefix      = "10.11.72.32/27"
    destination_address_prefix = "10.96.149.0/24"
  },
  DenyAllOtherTraffic = {
