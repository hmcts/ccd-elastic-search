...
resource "terraform_data" "vm" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "ansible-pull -U https://github.com/hmcts/ccd-elastic-search.git -C DTSPO-24943-extension -i ansible/inventory.ini ansible/diskmount.yml",
      "ansible-pull -U https://github.com/hmcts/ccd-elastic-search.git -C DTSPO-24943-extension -i ansible/inventory.ini ansible/main.yml --extra-vars 'ansible_hostname=${each.value.name} elastic_clustername=ccd-elastic-search-${var.env}'",
    ]
  }
