...
resource "terraform_data" "vm" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "ansible-pull -U https://github.com/hmcts/ccd-elastic-search.git -C DTSPO-24632-module-consume -i ansible/inventory.ini ansible/main.yml --extra-vars 'ansible_hostname=$(hostname) elastic_clustername=ccd-elastic-search-${var.env}'",
    ]
  }
